...
scoop install kubeclt

https://github.com/Ash258/scoop-Ash258/tree/master/bucket  
```

# ubuntuhttps://dev.to/mskian/install-z-shell-oh-my-zsh-on-ubuntu-1804-lts-4cm4  
...
    //shell: '',
    //git bash
    //shell: "C:\\Users\\Jason\\scoop\\apps\\git\\current\\git-cmd.exe",
    // ubuntu bash (needs WLS)
